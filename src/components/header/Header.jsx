        ...
        <div className="contentbox absolute h-full w-full top-0 left-0 pt-8 md:pt-14 text-[#725654] sm:flex justify-center items-center gap-10">
          <div className="left flex-1">
            ...
            <div className="btn w-full">
              <button className="hidden sm:flex items-center justify-center border-solid border-[2px] border-[#725654] py-2 px-10 mt-5 ">
                order online
              </button>
              <button className="flex sm:hidden w-full items-center justify-center border-solid border-[2px] border-[#725654] py-2 px-10 mt-5 ">
                order online
              </button>
            </div>
          </div>
          <div className="right flex-1 flex w-full justify-center sm:justify-start">
            <img src={Head} alt="" className="h-[35vh] md:h-[70vh] " />
          </div>
        </div>
      </div>
    </div>
